...
def update_app_ui(Tabs,month_value,date_value,region_value,country_value,state_value,city_value,attack_value,year_value,chart_year_selector,chart_dp_value,search,subtabs2):
    fig=None
    if Tabs=="Map":
        print("Data Type of region value=",str(type(month_value)))
        print("Data of region value is =",month_value)
        print("Data type of month value=",str(type(date_value)))
        print("Data of month value=",date_value)
        print("Data Type of date value=",str(type(region_value)))
        print("Data of date value=",region_value)
        ...
        print("Dta Type of city value=",str(type(city_value)))
        ...
        if new_df.shape[0]:
            ...
            #graph object figures for two things 1)data 2)layout
